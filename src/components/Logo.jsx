...
export default function Logo() {
  ...
  return (
    <div className={styles.logo}>
      <div className={styles.hair} style={{ fill: hairColor }}>
        <svg viewBox="0 0  153.1 126.87" xmlns="http://www.w3.org/2000/svg">
          <g>
            <g>
      ...
      <div className={styles.glasses} style={{ fill: glassColor }}>
          ...
          onClick={() => {
            if (!intervalRef.current) {
              intervalRef.current = setInterval(() => {
                setGlassColor(pickRandomColor());
                setHairColor(pickRandomColor());
              }, 100);
            }
          }}
        >
